...
function toggleLiteMode() {
    ...
    const iconSpan = btn.querySelector('.lite-icon');
    ...
    if (isLite) {
        // Modalità LITE attiva → icona sole, label "Normal"
        ...
        // Modalità NORMALE → icona luna, label "Lite"
        labelSpan.textContent = 'Lite';
        iconSpan.innerHTML = `
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
